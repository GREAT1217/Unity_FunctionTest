...
/// 圆形遮罩镂空引导
/// </summary>
public class GuideUICircle : MonoBehaviour, IUIGuide
{
    /// <summary>
    /// 要高亮显示的目标
    /// </summary>
    ...
    private void OnEnable()
    {
        ...
        //计算最终高亮显示区域的半径
        _radius = Vector2.Distance(WorldToCanvasPos(CurrentCanvas, _corners[0]), WorldToCanvasPos(CurrentCanvas, _corners[2])) / 2f;
        //计算高亮显示区域的圆心
        ...
        if (canRectTransform != null)
        {
            ...
            {
                _currentRadius = Mathf.Max(Vector3.Distance(WorldToCanvasPos(CurrentCanvas, corner), center), _currentRadius);
            }
        }
